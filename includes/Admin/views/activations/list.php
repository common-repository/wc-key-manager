...
?>
	<h1 class="wp-heading-inline">
		<?php esc_html_e( 'Activations', 'wc-key-manager' ); ?>
	...
	<form id="wckm-activations-table" method="get" action="<?php echo esc_url( admin_url( 'admin.php' ) ); ?>">
		<?php $this->list_table->views(); ?>
		<?php $this->list_table->search_box( __( 'Search', 'wc-key-manager' ), 'search' ); ?>
		<?php $this->list_table->display(); ?>
		<input type="hidden" name="page" value="wckm-keys"/>
		<input type="hidden" name="tab" value="activations"/>
	</form>
<?php
